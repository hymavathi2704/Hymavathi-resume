<template>
    <Article class="article-profile"
        ...
        <!-- Added description display here -->
        <p class="subtitle mb-4" v-html="description"></p>
...
// **New computed property for description**
const description = computed(() => {
    return localize(props.model.section.locales, "description")
})
